...
None of the above was fixed in this pass — Task 2 of this plan's brief is to
produce and triage the list, not to close it out; that is deliberate, so
the fix work happens with the categorization already agreed rather than
conflated with it.
