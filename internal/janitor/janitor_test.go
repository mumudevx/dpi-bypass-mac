...
// TestReplayReportsAFailedRevert and TestReplayReportsAnUnopenableJournal moved
// to janitor_perm_unix_test.go; see the build-tag comment there for why
// chmod(0o500) cannot deny a directory on Windows, and
// janitor_perm_windows_test.go for the same two properties denied a Windows way.
